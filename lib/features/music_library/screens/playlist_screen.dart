import 'dart:io';
import 'package:blazeplayer/features/music_library/screens/albums_screen.dart';
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => playlistScreens[i],
                              ),
                            );
                          },
                          child: ClipRRect(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: cardColors[i].withOpacity(0.18),
                                    blurRadius: 12,
                                    offset: Offset(0, 4),
                                  ),
                                ],
                                    ...
                                    decoration: BoxDecoration(
                                      gradient: LinearGradient(
                                        ...
                                        colors: [
                                          cardColors[i],
                                          cardColors[i],
                                          cardColors[i].withOpacity(0.98),
                                          cardColors[i].withOpacity(0.88),
                                          cardColors[i].withOpacity(0.6),
                                          cardColors[i].withOpacity(0.25),
                                          cardColors[i].withOpacity(0.05),
                                        ],
                                      ),
                                    ),
                                  ),
                      ...
                      builder: (context, playerProvider, _) {
                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            // Use different colors for custom playlists
