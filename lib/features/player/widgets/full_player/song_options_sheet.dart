      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildOption(Icons.playlist_add_rounded, 'Add to playlist', () {}),
            ...
            _buildOption(Icons.timer_rounded, 'Sleep timer', () {
              ...
              Navigator.of(context).pop(); // Close the SongOptionsSheet first
            ...
            _buildOption(Icons.ring_volume_rounded, 'Set as ringtone', () {}),
